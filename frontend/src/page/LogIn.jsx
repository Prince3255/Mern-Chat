          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              <div className='form-control'>
                ...
                <div className='relative'>
                  ...
                  <input type={showPassword ? 'text' : 'password'} onChange={(e) => (setFormData({ ...formData, password: e.target.value }))} value={formData.password} placeholder='••••••••' className='input input-bordered w-full pl-10' />
